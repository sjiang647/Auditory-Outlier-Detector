...
sequence = randperm(numTrial);
highlow = mod(sequence, 2); % 1 if high, 0 if low
outlierDiff = outlierRange(floor(mod(sequence, 8) ./ 2) + 1);
outlierPos = floor(mod(sequence, 56) ./ 8) + 1;
